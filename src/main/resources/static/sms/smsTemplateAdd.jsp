...
<div class="short-message">
	<div class="pos-relative">
		<div class="box-wrap pos-relative bg-common">
			...
			<div class="common-box-line text-center">
...
<script type="text/javascript">
	...
	$("#saveBtn").click(function(){
		var templateNumber = $("#templateNumber").val();
	   	...
	   	parent.elsDeskTop.showLoading('费用单保存中!');
		$.ajax({
			url :"${pageContext.request.contextPath}/rest/ElsSmsTemplateService/addSmsTemplate",
			type :"post",
			...
			success : function(data) {
				...
				parent.elsDeskTop.closeCurWin('smsTemplateAdd',callBack);
			},
			error : function(data) {
				parent.elsDeskTop.hideLoading();
