...
.edit-sub-title {
	...
	<form id="addI18nForm" action="" method="post">

		<div class="input-and-tip text-left ">
			<span class="edit-sub-title">
			<i18n:I18n key="i18n_common_title_key" defaultValue="资源Key:" /></span> 
			<input class="" type="text" id="key" name="key" /> 
			<span style="color: red" id="key_span"></span>
		</div>

		<div class="input-and-tip text-left ">
			<span class="edit-sub-title">
			<i18n:I18n key="i18n_common_title_value" defaultValue="资源Vlue:" />
			</span> <input class="" type="text" id="value" name="value" />
		</div>
		<div class="input-and-tip text-left ">
			<span class="edit-sub-title">
			<i18n:I18n key="i18n_common_title_language" defaultValue="语言选择:" />
			</span> 
	...
	<script type="text/javascript">
		...
		function iskey() {
			$.ajax({
				url : "../../rest/I18nService/getResourceBykey/" + key + "/"+ language,
				type : "GET",
		...
		function closeWin(){
	        ...
	        parent.elsDeskTop.closeCurWin('addI18n');
		}
		$("#addSubAccountOK").click(function() {
							...
							$.ajax({
										...
										type : "POST",
										contentType : "application/json",
										data : JSON.stringify({"key":key,"value":value,"language":language}),
										dataType : "json",
										success : function(data) {
											alert('<i18n:I18n key="i18n_account_alert_addSubAccountOK" defaultValue="新增成功" />');
											setTimeout(function() {
												closeWin();
											}, "1000");
										},
										error : function(data) {
											alert('<i18n:I18n key="i18n_account_alert_AddSi" defaultValue="新增失败" />');
										}
									});
						});
