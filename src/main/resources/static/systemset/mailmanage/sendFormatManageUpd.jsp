...
var formatId = "<%= formatId %>";
	...
	$(document).ready(function() {
		...
		$("#saveBtn").click(function(){
			...
			parent.elsDeskTop.tip.init({type: 'confirm',message:'<i18n:I18n key="test" defaultValue="是否确认保存？" />',closeEvent:function(){
				...
				$.ajax({
					url :"${pageContext.request.contextPath}/rest/MailInfoManageService/updateMailSendFormat",
					type :"post",
					...
					success : function(data) {
		    			...
		    			if(data.statusCode==-100){
		    				...
		    				parent.elsDeskTop.closeCurWin('sendFormatManageUpd',callBack);
		    			}
					},
					error : function(data) {
						parent.elsDeskTop.hideLoading();
	...
	function iniSendFormatInfo(){
		...
		$.ajax({
				url :"${pageContext.request.contextPath}/rest/MailInfoManageService/getMailSendFormat",
				type :"POST",
				contentType : "application/json",
				dataType : "json",
				data:JSON.stringify(frmObj),
	...
	$("#exitBtn").click(function(){
		parent.elsDeskTop.closeCurWin('sendFormatManageUpd');
	});
</script>
</body>
</html>