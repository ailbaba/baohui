...
var itemGrid = $('#itemTable').mmGrid({
    ...
    url : "${pageContext.request.contextPath}/rest/SaleAdditionCostService/querySaleAdditionItem",
    method : 'post',
    autoLoad : false,
    fullWidthRows : true,
    root:"rows",
...
var fileGrid = $('#fileTable').mmGrid({
    cols : fileCols,
    url : "${pageContext.request.contextPath}/rest/SaleAdditionCostService/querySaleAdditionFile",
    method : 'post',
    autoLoad : false,
    root:"rows",
    loadingText : "<i18n:I18n defaultValue='正在载入' key='i18n_common_mmgrid_loadingtext'/>",
...
$(document).ready(function(){
	...
	function initData(){
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/rest/SaleAdditionCostService/querySaleAdditionCostHead",
			type : "post",
	...
	$("#saveBtn").click(function(){
		...
		$.ajax({
			url :"${pageContext.request.contextPath}/rest/SaleAdditionCostService/updSaleAdditionCost",
			type :"post",
			...
			success : function(data) {
				...
				parent.elsDeskTop.tip.init({type: 'confirm',message:'<i18n:I18n key="i18n_common_confirm_returnParentPage" defaultValue="是否返回上级页面？" />',closeEvent:function(){
					parent.elsDeskTop.closeCurWin('saleAdditionCostUpd',callBack);
				}});
			},
			error : function(data) {
				parent.elsDeskTop.hideLoading();
   ...
   $("#columnDefineBtn").click(function(){
		parent.elsDeskTop.defineWin({
		    ...
		    windowSubTitle : "",
		    iframSrc : "${pageContext.request.contextPath}/tablecolumn/subAccountColumnSetting.jsp?elsAccount=" + elsAccount + "&elsSubAccount="+elsSubAccount + "&tableCode=saleAdditionCostAddItem_mt&window=iframeApp_saleAdditionCostAdd",
		    showAdv : true,
