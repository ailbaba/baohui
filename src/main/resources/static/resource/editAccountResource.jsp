...
<script type="text/javascript">
	...
	queryUrl 			= "<%=basePath %>rest/AccountResourceService/getAccountResourceTree/"+elsAccount+"/"+elsSubAccount,
	...
	saveData  = function(){
		...
		$.ajax({
			...
			data : JSON.stringify({elsAccount:elsAccount,elsSubAccount:elsSubAccount,params:s}),
			dataType : "json",
	...
	function closeWin(){
		parent.elsDeskTop.closeCurWin('editAccountResource');
	}
</script>
<body>
