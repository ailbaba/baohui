				    	...
				    	<tbody>
				    		<tr>
				    			...
				    			<td colspan="1" align="left">
				    				<input id="" name="" type="text" style="width: 200px;" disabled="disabled" value="自动凭证号"/>
								</td>
				    		</tr>
				    		<!-- <tr>
...
//===========================================样品信息===========================================     		
var material_item = [//{ title:'采购凭证号', name:'purchaseSampleItemVOList[][purchaseSampleNumber]', width: 100, align: 'center',renderer:initPurchaseSampleNumber},
	  	            { title:'物料编号', name:'purchaseSampleItemVOList[][materialNumber]', width: 100, align: 'center',renderer:initInputAny},
	  	            { title:'物料描述', name:'purchaseSampleItemVOList[][materialDesc]', width: 100, align: 'center',renderer:initInputAny},
	  		        //{ title:'物料行编号', name:'purchaseSampleItemVOList[][materialLineNumber]', width: 100, align: 'center',renderer:initInputAny},
	  		        { title:'属性1', name:'purchaseSampleItemVOList[][property1]', width: 100, align: 'center',renderer:initInputAny},
	  		        { title:'属性2', name:'purchaseSampleItemVOList[][property2]', width: 100, align: 'center',renderer:initInputAny},
	  		        { title:'属性3', name:'purchaseSampleItemVOList[][property3]',width:100, align:'center' ,renderer:initInputAny},
	  		        { title:'属性4', name:'purchaseSampleItemVOList[][property4]',width:100, align:'center',renderer:initInputAny},
	  		        { title:'属性5', name:'purchaseSampleItemVOList[][property5]',width:120, align:'center' ,renderer:initInputAny},
	  		        { title:'样品订单数量', name:'purchaseSampleItemVOList[][quantity]', width: 120, align: 'center',renderer:initInputNumber},
	  				//{ title:'样品订单金额', name:'purchaseSampleItemVOList[][price]', width: 100, align: 'center',renderer:initInputAny},
	  				{ title:'基本数量单位', name:'purchaseSampleItemVOList[][unitQuantity]',width:100, align:'center',renderer:initInputAny},
	  				{ title:'价格单位兼订单单位', name:'purchaseSampleItemVOList[][unitPrice]',width:100, align:'center',renderer:initInputAny},
	  				{ title:'度量单位', name:'purchaseSampleItemVOList[][unitMeasure]',width:100, align:'center',renderer:initInputAny},
	  				{ title:'工厂', name:'purchaseSampleItemVOList[][factory]',width:100, align:'center',renderer:initInputAny},
	  				{ title:'采购样品日期', name:'purchaseSampleItemVOList[][orderDate]' ,width:100, align:'center', renderer:formatDateInput},
	  				{ title:'网格值', name:'purchaseSampleItemVOList[][gridValue]', width: 100, align: 'center', renderer:initInputAny},
	  				{ title:'备注', name:'purchaseSampleItemVOList[][remark]',width:150, align:'center',renderer:initInputAny}];
...
{ title:'文件大小', name:'fbk1', width:100, align:'center',renderer:function(val){
	return "<input name='purchaseSampleFileVOList[][fbk1]' type='text'  value='"+val+"'/>";
}},
...
$("#exitBtn").click(function(){
		parent.elsDeskTop.closeCurWin('purchaseSampleManageAdd');
	});
...
function sendSample(){
    ...
    parent.elsDeskTop.showLoading('样品信息发布中');
	$.ajax({
		url : "<%=basePath%>rest/PurchaseSampleService/sendSample",
		type : "post",
		contentType : "application/json",
		...
		success : function(data) {
			...
			if(data.statusCode=="-100"){
				...
				alert("创建成功!");
				parent.elsDeskTop.closeCurWin('purchaseSampleManageAdd',callBack);
			}
