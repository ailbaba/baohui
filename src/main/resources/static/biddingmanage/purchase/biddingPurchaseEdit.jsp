    ...
    <div class="pos-relative public-wrap">
        <div class="box-wrap pos-relative bg-common">
            ...
            <div class="common-box-line">
             <button id="saveBtn" class="button-wrap"><i18n:I18n key="test" defaultValue="保存" /></button>
            ...
            <div class="common-box-line">
					  ...
					  <table>
				    	<tbody>
				    		...
				    		<tr>
				    			...
				    			<td colspan="1" align="left">
									<textarea id="remark" name="remark" style="width:500px;height:80px" ></textarea>
								</td>
				    		</tr>
				    	</tbody>
				       </table>
				...
				<div id="edit-line-connType">
					<div class="input-and-tip">
						<span>招标单位:</span> 
						<input id="tenderCompany" name="tenderCompany" type="text" style="width: 500px;"  />
					</div>
					<div class="input-and-tip">
						<span>负  责  人:</span>&nbsp;
						<input id="principal" name="principal" type="text" style="width: 500px;" />
					</div>
					<div class="input-and-tip">
						<span>联系电话:</span> 
						<input id="telephone" name="telephone" type="text" style="width: 500px;" />
					</div>
					<div class="input-and-tip">
						<span>电子邮箱:</span> 
						<input id="email" name="email" type="text" style="width: 500px;" />
					</div>
					<div class="input-and-tip">
						<span>电子传真:</span> 
						<input id="fax" name="fax" type="text" style="width: 500px;" />
					</div>
					<div class="input-and-tip">
						<span>联系地址:</span> 
						<input id="address" name="address" type="text" style="width: 500px;" />
					</div>
				</div>
			    	...
			    	<tbody>
			    		...
			    		<tr>
			    			...
			    			<td colspan="3" align="left">
								<input id="" name="" type="text" style="width: 300px;" value="10000" />
								<select id="" name="">
									<option>CNY</option>
									<option>HK</option>
									<option>USD</option>
			    		...
			    		<tr>
			    			...
			    			<td colspan="3" align="left">
								<input type="text" class="Wdate" onfocus="WdatePicker({lang:'<%=session.getAttribute("language") %>'})" id="beginDate" name="beginDate" value="2016-02-24" />
				  				<span><i18n:I18n key="test" defaultValue="到" /></span>
	                    		<input type="text" class="Wdate" onfocus="WdatePicker({lang:'<%=session.getAttribute("language") %>'})" id="endDate" name="endDate" value="2016-02-27" />
							</td>
			    		</tr>
			    		<tr>
			    			<td colspan="1" align="right"><i18n:I18n key="test" defaultValue="保证金细节规则:" /></td>
			    			<td colspan="3" align="left">
								<textarea style="width: 500px; height: 80px" >招标细节管理规则如下：1、公开原则 2、数据真实性</textarea>
							</td>
			    		</tr>
			    	</tbody>
			      </table>
                  	   ...
                  	   <table>
					    	<tbody>
					    		<tr>
					    			...
					    			<td colspan="1" align="left">
										<textarea id="contentremark" name="contentremark" style="width: 800px; height: 80px"></textarea>
									</td>
					    		</tr>
					    		<tr>
					    			<td colspan="1" align="right"><i18n:I18n key="test" defaultValue="所属项目:" /></td>
					    			<td colspan="1" align="left">
										<input id="contentbiddingProjectNumber" name="biddingProjectNumber" type="text" style="width: 200px;" />
										<input id="contentfbk1" name="fbk1" type="text" style="width: 300px;" />
									</td>
					    		</tr>
					    	</tbody>
					   </table>
...
//window.beforeClose='<i18n:I18n defaultValue="确认关闭?修改的内容将不被保存" key=""/>';
...
$("#exitBtn").click(function(){
	 endFormJson = $("#form").serializeJSON();
		...
		console.log(end);
		if(begin==end){
			parent.elsDeskTop.closeCurWin('UpdBiddingMain');
		}else{
		parent.elsDeskTop.tip.init({
			type: 'confirm',message:'<i18n:I18n defaultValue="确认关闭?修改的内容将不被保存" key=""/>',
					closeEvent:function(){
...
//     $("#biddingTypeInput").val($("#biddingType option:selected").val());
    ...
    parent.elsDeskTop.showLoading('修改中');
	$.ajax({
		url : "<%=basePath%>rest/PurchaseEnquiryBiddingService/UpdatePurchaseBiddingInfo",
		type : "post",
		contentType : "application/json",
