...
<div class="box-wrap pos-relative bg-common">
	 ...
	 <div class="common-box-line">
	     <div class="dis-in-b input-and-tip">
			<table>
				<tr>
					<td><i18n:I18n defaultValue="模板编码" key="i18n_contractTemplate_templateNumber"/>:</td>
					<td><input type="text" id="templateNumber" name="templateNumber" readonly="readonly" /></td>
					<td><i18n:I18n defaultValue="模板名称" key="i18n_contractTemplate_templateDesc"/>:</td>
					<td><input type="text" id="templateDesc" name="templateDesc" width="200px;" /></td>
					<td><i18n:I18n defaultValue="模板类型" key="i18n_contractTemplate_templateType"/>:</td>
					<td>
...
var clauseGrid = $('#clauseTable').mmGrid({
	...
	$("#saveBtn").click(function(){
		...
		$.ajax({
			url :"${pageContext.request.contextPath}/rest/ContractManageService/addContractTemplate",
			type :"post",
			...
			success : function(data) {
				...
				parent.elsDeskTop.tip.init({type: 'confirm',message:'<i18n:I18n key="i18n_common_confirm_returnParentPage" defaultValue="是否返回上级页面？" />',closeEvent:function(){
					parent.elsDeskTop.closeCurWin("contractTemplateAdd",callBack);
				}});
			},
			error : function(data) {
				parent.elsDeskTop.hideLoading();
