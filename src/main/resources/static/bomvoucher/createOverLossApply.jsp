    ...
    <div class="pos-relative ">
        <div class="box-wrap pos-relative bg-common">
            ...
            <div class="common-box-line">
                <button id="addBtn" class="button-wrap">新建超损单</button>
...
<%--                 <button id="exitBtn" class="button-wrap"><i18n:I18n key="i18n_button_exit" defaultValue="退出" /></button> --%>
        ...
        <div class="box-wrap pos-relative bg-common">
            ...
            <form style="margin:0;" id="queryForm" onsubmit="return false;" method="POST" action="<%=basePath%>rest/BomVoucherService/queryBomListForOverLoss">
...
var cols_item = [{title:"对方公司名称",name:"companyShortName",align:"center",width:154},
                 {title:"销售订单号",name:"saleOrderNumber",align:"center",width:130},
                 {title:"采购订单号",name:"purchaseOrderNumber",align:"center",width:130},
                 ...
                 {title:"要求交期",name:"deliveryDate",align:"center",width:100,renderer:function(val){
                	 if (!val) { return ""; } return new Date(val).format("yyyy-MM-dd"); }
                 },
                 {title:"订单数量",name:"quantity",align:"center",width:100,renderer:function(val){
                	 return numberFormat(val,"")}
                 },
                 {title:"基本单位数量",name:"unitQuantity",align:"center",width:110},
                 {title:"未交货数量",name:"noDeliverQuantity",align:"center",width:100,renderer:function(val){
                	 return numberFormat(val,"")}
                 },
                 {title:"发货在途数量",name:"onWayQuantity",align:"center",width:100,renderer:function(val){
                	 return numberFormat(val,"")}
                 },
                 {title:"对方已收货数",name:"receivedQuantity",align:"center",width:100,renderer:function(val){
                	 return numberFormat(val,"")}
                 },
                 {title:"对方退货数",name:"returnQuantity",align:"center",width:100,renderer:function(val){
                	 return numberFormat(val,"")}
                 },
                 ...
                 {title:"出货工厂",name:"factory",align:"center",width:110},
                 {title:"收货工厂",name:"receiptFactory",align:"center",width:110},
                 {title:"基本单位",name:"basicUnit",align:"center",width:100},
                 {title:"订单单位",name:"unitPrice",align:"center",width:100}];
...
function addDelivery() {
	...
	parent.elsDeskTop.defineWin({
        ...
        'windowTitle':'新建超损申请',
        windowSubTitle: "",
        'iframSrc':'<%=basePath%>bomvoucher/editOverLossApply.jsp?toElsAccount='+toElsAccount+'&selectedItems=' + selectedItems,
