    ...
    $.fn.SumoSelect = function (options) {
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                placeholder: '',
                optDiv: '',
                optAfter:settings.optAfter,
                optCancel:settings.optCancel,
                CaptionCont: '',
                is_floating: false,
                is_opened: false,
                //backdrop: '',
                ...
                createElems: function () {
                    ...
                    if(O.optAfter){
                        O.optDiv.addClass('SumoSelect')
                        var $a =$(O.optAfter);
                        var $c = $(O.optCancel);
                        $a.after(O.optDiv);
                        $c.on('mousewheel mousedown scroll', O.hideOpts.bind(O));
                    }else
...
//                                O.hideOpts();
                    ...
                    if(O.optAfter){
                        var pos = O.select.offset();
                        pos.top = pos.top+ O.select.outerHeight();
                        O.optDiv.offset(pos);
                        O.optDiv.width(O.select.width());
                    }
