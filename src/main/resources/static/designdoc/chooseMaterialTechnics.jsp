...
<%-- <span class="dis-in-b pos-absolute box-tip bg-common"><i18n:I18n key="i18n_common_title_conditionquery" defaultValue="条件查询" /></span> --%>
     <form style="margin:0;" id="form" onsubmit="return false;">
          ...
          <div class="common-box-line">
             <div class="dis-in-b input-and-tip"><span class="text-right w-72">材质工艺代码：</span><input name="materialNumber" type="text"/></div>
             <div class="dis-in-b input-and-tip"><span class="text-right w-72">材质工艺描述：</span><input name="materialName" type="text"/></div>
...
var grid;
var cols = [
            { title:'<i18n:I18n key="i18n_common_lable_materialxxx" defaultValue="材质工艺代码" />', name:'materialNumber' ,width:120, align:'center'},
            { title:'<i18n:I18n key="i18n_material_xxx" defaultValue="材质工艺描述" />', name:'materialName' ,width:400, align:'center'}
...
function init(){
    ...
    grid.on('cellSelected',function(e, item, rowIndex, colIndex){
    	parent.elsDeskTop.closeCurWin('chooseMaterialTechnics',closeCallback(item));
	});
...
function closeCallback(item){
 	if (parent.frames["iframeApp_createDesignDoc"]) {
		parent.frames["iframeApp_createDesignDoc"].fillMaterialTechnic(item);
	}
}
</script>
</body>
