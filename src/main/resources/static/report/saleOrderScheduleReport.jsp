...
<body>
	...
	<form id="queryForm" onsubmit="return false;" method="POST">
		<div class="box-wrap pos-relative bg-common">
			<span class="dis-in-b pos-absolute box-tip bg-common"><i18n:I18n key="i18n_common_title_conditionquery" defaultValue="条件查询" /></span>
				...
				<div class="common-box-line">
				    ...
				    <!-- 
				    <div class="dis-in-b input-and-tip">
						<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_materialRelation_title_purchaseName" defaultValue="采购方名称" />： </span>
					...
					<div class="dis-in-b input-and-tip">
					 ...
					 -->
					<div class="dis-in-b input-and-tip">
						<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_title_saleOrder" defaultValue="销售订单" />：</span>
		...
		<div class="box-wrap pos-relative bg-common">
			<span class="dis-in-b pos-absolute box-tip bg-common"><i18n:I18n key="i18n_report_saleschedule" defaultValue="销售订单进度报表" /></span>
			<div class="common-box-line">
				<main class="grid-container">
				<div class="grid-100" id="saleOrderScheduleReportGrid">
					<table id="saleOrderScheduleReportTable"></table>
	...
	var cols = <base:tableColumn elsAccount="${elsAccount}" elsSubAccount="${elsSubAccount}" tableCode="saleOrderScheduleReport"/>;
	function installTable(){
		$('#saleOrderScheduleReportGrid').html('<table id="saleOrderScheduleReportTable"></table><div id="pg" style="text-align: right;"></div>');
		//本地示例
	     var headGrid= $('#saleOrderScheduleReportTable').mmGrid({
	    	 cols: cols,
	         url: "<%=basePath%>rest/SaleOrderService/findSaleOrderScheduleList",
	    ...
	    headGrid.on('loadSuccess',function(e, d) {
				//高亮
		        $('#saleOrderScheduleReportTable').find("tr").each(function(){
		        	if(d.total=="0"){
						return;		    			
		    		}
	...
	$("#columnDefineBtn").click(function(){
		 $("#columnDefineBtn").click(function(){
		     parent.elsDeskTop.defineWin({
		    	    ...
		    	    'iframSrc':'<%=basePath%>tablecolumn/subAccountColumnSetting.jsp?elsAccount=' + elsAccount + "&elsSubAccount="+elsSubAccount + "&tableCode=saleOrderScheduleReport" + "&window=iframeApp_saleOrderScheduleReport",
		    	    windowMinWidth  : 480,
		    	    windowMinHeight : 600,
		    	    'windowWidth'   : 480,
		    	    'windowHeight'  : 600,
