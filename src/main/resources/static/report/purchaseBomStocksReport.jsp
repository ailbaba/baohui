...
<body>
    ...
    <div class="box-wrap pos-relative bg-common">
     ...
     <div class="box-wrap pos-relative bg-common">
     	   <span class="dis-in-b pos-absolute box-tip bg-common"><i18n:I18n key="i18n_common_lable_purchaseorxxrreport" defaultValue="采购订单外协库存报表" /></span>
		   <div class="common-box-line">
...
function initDataGrid(){
	itemGrid = $('#table-item').mmGrid({
        cols: cols,
        url : "<%=basePath%>rest/PurchaseOrderService/findPurchaseBomStocksReport",
...
$("#downloadBtn").click(function(){
	...
	$.ajax({
		url :"<%=basePath%>rest/PurchaseOrderService/exportBomStocksReportAsExcel",
		dataType : "json",
		type :"post",
...
$("#exitBtn").click(function(){
	parent.elsDeskTop.closeCurWin('purchaseBomStocksReport',null);
});
</script>
</body>
</html>