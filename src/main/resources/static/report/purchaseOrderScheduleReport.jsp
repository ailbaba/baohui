...
<body>
	...
	<form id="queryForm" onsubmit="return false;" method="POST">
		<div class="box-wrap pos-relative bg-common">
			<span class="dis-in-b pos-absolute box-tip bg-common"><i18n:I18n key="i18n_common_title_conditionquery" defaultValue="条件查询" /></span>
				...
				<div class="common-box-line">
					...
					<div class="dis-in-b input-and-tip">
						<span class="dis-in-b text-right w-72"><i18n:I18n key="" defaultValue="采购方ELS号" />：</span>
						<input id="purchaseElsAccount" name="purchaseElsAccount" type="text" />
					</div>
					<div class="dis-in-b input-and-tip">
		...
		<div class="box-wrap pos-relative bg-common">
			<span class="dis-in-b pos-absolute box-tip bg-common"><i18n:I18n key="i18n_purchase_schedulereport" defaultValue="订单进度报表" /></span>
			<div class="common-box-line">
	...
	var cols = <base:tableColumn elsAccount="${elsAccount}" elsSubAccount="${elsSubAccount}" tableCode="purchaseOrderScheduleReport"/>;
	function installTable(){
		...
		//本地示例
	     var headGrid= $('#purchaseOrderScheduleReportTable').mmGrid({
	    	 cols: cols,
	         url: "<%=basePath%>rest/PurchaseOrderService/order/findPurchaseOrderScheduleList",
	...
	$("#columnDefineBtn").click(function(){
		 $("#columnDefineBtn").click(function(){
		     parent.elsDeskTop.defineWin({
		    	    ...
		    	    'iframSrc':'<%=basePath%>tablecolumn/subAccountColumnSetting.jsp?elsAccount=' + elsAccount + "&elsSubAccount="+elsSubAccount + "&tableCode=purchaseOrderScheduleReport" + "&window=iframeApp_purchaseOrderScheduleReport",
		    	    windowMinWidth  : 480,
		    	    windowMinHeight : 600,
		    	    'windowWidth'   : 480,
		    	    'windowHeight'  : 600,
	...
	$("#downloadBtn").click(function(){
		...
		$.ajax({
			url :"<%=basePath%>rest/PurchaseOrderService/order/scheduleExportAsExcel",
			dataType : "json",
			type :"post",
