...
<body>
    ...
    <div class="box-wrap pos-relative bg-common">
		 ...
		 <input type="hidden" name="purchaseCompany" value="${companyShortName}" />
         <div class="common-box-line">
				...
				<div class="dis-in-b input-and-tip">
					<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_common_lable_materialnuxx" defaultValue="采购方产品编号" />： </span>
					<input type="text" id="mn" name="mn" />
				</div>
				<div class="dis-in-b input-and-tip">
					<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_common_lable_materialnuxx" defaultValue="采购方产品名称" />： </span>
					<input type="text" id="md" name="md" />
				</div>
				<div class="dis-in-b input-and-tip">
					<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_common_title_supplissaccount" defaultValue="销售方ELS" />： </span>
					<input type="text" id="toElsAccount" name="toElsAccount" />
				</div>
				<div class="dis-in-b input-and-tip">
					<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_common_lable_supplissompany" defaultValue="销售方名称" />： </span>
     ...
     <div class="box-wrap pos-relative bg-common">
     	   <span class="dis-in-b pos-absolute box-tip bg-common"><i18n:I18n key="i18n_common_lable_purchaseorxxrreport" defaultValue="采购订单外协耗用报表" /></span>
		   <div class="common-box-line">
...
var itemGrid;
var cols = [       { title:'<i18n:I18n key="i18n_common_lable_elsAccount" defaultValue="采购方ELS号" />', name:'elsAccount' ,width:100, align:'center'},
                   { title:'<i18n:I18n key="i18n_common_lable_xxxt" defaultValue="采购方名称" />', name:'purchaseCompany' ,width:150, align:'center', renderer:function(val){
         	           return companyShortName; 
                   }},
                   { title:'<i18n:I18n key="i18n_common_lable_toElsAccount" defaultValue="销售方ELS号" />', name:'toElsAccount' ,width:100, align:'center'},
                   { title:'<i18n:I18n key="i18n_common_lable_xxxt" defaultValue="销售方名称" />', name:'companyShortName' ,width:150, align:'center'},
                   ...
                   { title:'<i18n:I18n key="i18n_common_lable_xxx" defaultValue="采购方产品编号" />', name:'mn' ,width:100, align:'center'},
                   { title:'<i18n:I18n key="i18n_common_lable_xxx" defaultValue="采购方产品名称" />', name:'md' ,width:100, align:'center'},
...
function initDataGrid(){
	itemGrid = $('#table-item').mmGrid({
        cols: cols,
        url : "<%=basePath%>rest/PurchaseOrderService/findPurchaseOrderBomReport",
...
$("#downloadBtn").click(function(){
	...
	$.ajax({
		url :"<%=basePath%>rest/PurchaseOrderService/exportBomReportAsExcel",
		dataType : "json",
		type :"post",
...
$("#exitBtn").click(function(){
	parent.elsDeskTop.closeCurWin('purchaseOrderBomReport',null);
});
</script>
</body>
</html>