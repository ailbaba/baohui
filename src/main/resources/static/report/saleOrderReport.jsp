...
<body>
	...
	<form id="queryForm" onsubmit="return false;" method="POST" action="<%=basePath%>rest/SaleOrderService/findSaleOrderReport">
			...
			<span class="dis-in-b pos-absolute box-tip bg-common"><i18n:I18n key="i18n_common_title_conditionquery" defaultValue="条件查询" /></span>
				...
				<div class="common-box-line">
					<div class="dis-in-b input-and-tip">
						<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_common_lable_custorels" defaultValue="客户ELS号" />： </span><input
							type="text" name="toElsAccount" />
					</div>
					<div class="dis-in-b input-and-tip">
						<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_common_lable_companyname" defaultValue="公司名称" />： </span><input
							type="text" name="companyShortName" />
					</div>
					<div class="dis-in-b input-and-tip">
						<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_label_saleOrderNumber" defaultValue="销售订单" />：</span><input
							name="saleOrderNumber" type="text" />
					</div>
					<div class="dis-in-b input-and-tip">
						<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_common_label_factory" defaultValue="工厂" />： </span><input
							type="text" name="factory" />
					</div>
					<div class="dis-in-b input-and-tip">
						<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_common_lable_materialnumber" defaultValue="物料号" />： </span><input
							type="text" name="saleMaterialNumber" />
					</div>
					<br>
					<div class="dis-in-b input-and-tip">
					...
					<div class="dis-in-b input-and-tip">
						<span>到 </span><input type="text" id="endOrderDate" class="Wdate"
							onfocus="WdatePicker()" name="endOrderDate" />
					</div>
					
					<div class="dis-in-b input-and-tip">
						<span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_label_logtime" defaultValue="时间戳" />：</span>
					</div>
					<div class="dis-in-b input-and-tip">
					...
					<div class="dis-in-b input-and-tip">
						<span><i18n:I18n key="i18n_label_to" defaultValue="到" /> </span><input type="text" id="endTime" class="Wdate"
		...
		<div class="box-wrap pos-relative bg-common">
			<span class="dis-in-b pos-absolute box-tip bg-common"><i18n:I18n key="i18n_common_lable_saleorderreport" defaultValue="销售订单报表" /></span>
			<div class="common-box-line">
				<main class="grid-container">
				<div class="grid-100">
					<table id="saleOrderReportTable"></table>
	...
	var itemGrid;
	var cols = <base:tableColumn elsAccount="${elsAccount}" elsSubAccount="${elsSubAccount}" tableCode="saleOrderReport"/>;
	...
	function installTable(){
		var frm = $("#queryForm");
		if(!itemGrid){
		         itemGrid= $('#saleOrderReportTable').mmGrid({
		    	 cols: cols,
			     url : frm[0].action,
	...
	function columnDefine(){
    	parent.elsDeskTop.defineWin({
    	    ...
    	    windowSubTitle: "",
    	    'iframSrc':'<%=basePath%>tablecolumn/subAccountColumnSetting.jsp?elsAccount=' + elsAccount + "&elsSubAccount="+elsSubAccount + "&tableCode=saleOrderReport" + "&window=iframeApp_saleOrderReport",
    	    windowMinWidth: 480,
    	    windowMinHeight: 600,
    	    'windowWidth':480,
    	    'windowHeight':600,
	...
	$("#downloadBtn").click(function(){
		...
		$.ajax({
			url :"<%=basePath%>rest/SaleOrderService/exportAsExcel",
			dataType : "json",
			type :"post",
