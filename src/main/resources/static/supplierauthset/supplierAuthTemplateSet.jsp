...
$().ready(function(){
	...
	$("#exitBtn").click(function(){
		parent.elsDeskTop.closeCurWin('supplierAuthTemplateSet');
	});
	$("#saveBtn").click(function(){
		$.ajax({
			url :"<%=basePath%>rest/SupplierAuthSetService/updateSupplierAuthTemplateSet",
			type : "post",
	...
	$.ajax({
		...
		success : function(data) {
			...
			grid= $('#table-head').mmGrid({
		    	 cols: cols,
		    	 url : "<%=basePath%>rest/SupplierAuthSetService/getSupplierAuthTemplateSet",
		         method:  "get",
		         root:"rows",
