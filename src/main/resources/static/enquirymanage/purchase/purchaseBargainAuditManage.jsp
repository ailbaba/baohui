...
var purchaseEnquiryNumberApps = purchaseEnquiryNumberApp.split(",");
var toElsAccount = purchaseEnquiryNumberApps[0];
var purchaseEnquiryNumber = purchaseEnquiryNumberApps[1];
var materialLineNumber = purchaseEnquiryNumberApps[2];
var taxRate=[];
var orderType;
var beginDate;
var endDate;
...
$("#materialColumnDefineBtn").click(function(){
	 parent.elsDeskTop.defineWin({
	     ...
	     'windowTitle':'列自定义',
	     windowSubTitle: "",
	     'iframSrc':'<%=basePath%>tablecolumn/subAccountColumnSetting.jsp?elsAccount=' + elsAccount + "&elsSubAccount="+elsSubAccount + "&tableCode=purchaseEnquiryBargainMaterial" + "&window=iframeApp_auditRecord",
	     windowMinWidth: 480,
	     windowMinHeight: 600,
	     'windowWidth':480,
	     'windowHeight':600,
...
$("#itemColumnDefineBtn").click(function(){
	 parent.elsDeskTop.defineWin({
	     ...
	     'windowTitle':'列自定义',
	     windowSubTitle: "",
	     'iframSrc':'<%=basePath%>tablecolumn/subAccountColumnSetting.jsp?elsAccount=' + elsAccount + "&elsSubAccount="+elsSubAccount + "&tableCode=purchaseEnquiryBargainItem" + "&window=iframeApp_auditRecord",
	     windowMinWidth: 480,
	     windowMinHeight: 600,
	     'windowWidth':480,
	     'windowHeight':600,
...
var file_cols =  <base:tableColumn elsAccount="${elsAccount}" elsSubAccount="${elsSubAccount}" tableCode="purchaseEnquiryBargainFile_mt"/>;
