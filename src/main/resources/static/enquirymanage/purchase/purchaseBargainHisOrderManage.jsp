...
<body>
	<div class="pos-relative public-wrap ">
		<div class="box-wrap pos-relative bg-common">
			...
			<div class="common-box-line">
				...
				<div class="dis-in-b input-and-tip">
					...
					<button class="button-wrap"><i18n:I18n key="i18n_button_exit" defaultValue="退出" /></button>
				</div>
			</div>
			</form>
		</div>
        <div class="box-wrap pos-relative bg-common">
            ...
            <div class="common-box-line">
               ...
               <div class="grid-100"  id="purchaseEnquiryHeaderGrid">
				   <table id = "purchaseEnquiryHeaderTable"></table>
	...
	$(document).ready(function()
	{
		...
		var paramStr = {"elsAccount":elsAccount,"purchaseEnquiryNumber":""};

		headGrid= $('#purchaseEnquiryHeaderTable').mmGrid({
	    	 cols        : cols,
 		...
 		headGrid.on('cellSelected', function (e, item, rowIndex, colIndex) {
 			if($(e.target).is('.reportMoney')) {
 				...
 				//兼容ie 冒泡事件    <i18n:I18n defaultValue="议价历史管理" key="i18n_common_negotiation_history_management"></i18n:I18n>
 			    ...
 			    parent.elsDeskTop.defineWin({
 			        ...
 			        'windowsId'      : 'bargainHisInfo',
 			        'windowTitle'    : '<i18n:I18n defaultValue="议价历史管理" key="i18n_common_negotiation_history_management"></i18n:I18n>',
 			        'windowSubTitle' : toCompanyName,
 			        'iframSrc'       : '<%=basePath%>enquirymanage/purchase/bargainHisManage.jsp?toElsAccount=' + toElsAccount + "&elsAccount=" + elsAccount + "&purchaseEnquiryNumber="+purchaseEnquiryNumber + "&logtime=" + logtime,
		...
		$("#seachBtn").click(function(){
			...
			var paramStr              = {"elsAccount":elsAccount,"purchaseEnquiryNumber":$("#purchaseEnquiryNumber").val(),"logtime":$("#logtime").val()};
