			...
			<div class="common-box-line">
				...
				<div class="dis-in-b input-and-tip">
					...
					<select class="" id="state" name="state">
						<option value="0"><i18n:I18n key="test" defaultValue="未认证" /></option>
						<option value="1"><i18n:I18n key="test" defaultValue="已认证" /></option>
					</select>
				</div>
			</div>
			</form>
...
<script type="text/javascript">
	...
	$("#exitBtn").click(function(){			
			parent.elsDeskTop.closeCurWin('supplierCertificateInfoManage');
	});
