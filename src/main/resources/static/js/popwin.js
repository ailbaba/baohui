...
showWin: function(width, height, title, src) {
        ...
        inntHtml += '<div id="maskTitle" style="height: 30px; line-height: 25px; font-family: Microsoft Yahei; font-size: 12px; color: #333333; padding-left: 10px; background-image: url(data:image/png;base64,); border-bottom: 1px solid #999999; position: relative;">'
        inntHtml += '' + title + ''
