...
<body>
	...
	<script type="text/javascript"
        ...
        <div class="box-wrap pos-relative bg-common">
            ...
            <form id="queryForm" onsubmit="return false;" method="POST" action="<%=basePath%>rest/SaleOrderService/findSaleOrderHis">
            ...
            <div class="common-box-line">
                ...
                <div class="dis-in-b input-and-tip"><span class="dis-in-b text-right w-72"><i18n:I18n key="i18n_saleorderhis_title_salematerialnumber" defaultValue="销售物料号" />： </span><input type="text" name="saleMaterialNumber"/></div>
...
<script type="text/javascript">
var itemGrid;
var cols_item = <base:tableColumn elsAccount="${elsAccount}" elsSubAccount="${elsSubAccount}" tableCode="querySaleOrderHis"/>;
$().ready(function(){
	init();
});
...
function init(){
	...
	$("#exitBtn").click(function(){
		if (winId) {
			...
			parent.elsDeskTop.closeCurWin('querySaleOrderHis',closeCallback());
		}
	});
...
$("#columnDefineBtn").click(function(){
	parent.elsDeskTop.defineWin({
        ...
        windowSubTitle: "",
        'iframSrc':'<%=basePath%>tablecolumn/subAccountColumnSetting.jsp?elsAccount=' + elsAccount + "&elsSubAccount="+elsSubAccount + "&tableCode=querySaleOrderHis" + "&window=iframeApp_querySaleOrderHis",
        windowMinWidth: 480,
        windowMinHeight: 600,
        'windowWidth':480,
        'windowHeight':600,
